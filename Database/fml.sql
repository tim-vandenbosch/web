...
--
-- Host: 127.0.0.1
-- Gegenereerd op: 15 mei 2016 om 16:13
...
CREATE TABLE `tickets` (
  ...
  `blokID` int(3) NOT NULL,
  `lokaalNummer` int(4) NOT NULL,
  `datum` date NOT NULL,
...
ALTER TABLE `tickets`
  ...
  ADD KEY `ticket_aanmaker_fk` (`aanmaker`),
  ADD KEY `ticket_lokaal_fk` (`lokaalNummer`),
  ADD KEY `ticket_campus_fk` (`campusID`),
  ADD KEY `tickets_blok_fk` (`blokID`);
...
ALTER TABLE `tickets`
  ...
  ADD CONSTRAINT `ticket_campus_fk` FOREIGN KEY (`campusID`) REFERENCES `campussen` (`campusID`),
  ADD CONSTRAINT `ticket_hersteller_fk` FOREIGN KEY (`hersteller`) REFERENCES `users` (`userID`) ON DELETE NO ACTION ON UPDATE CASCADE,
  ADD CONSTRAINT `ticket_lokaal_fk` FOREIGN KEY (`lokaalNummer`) REFERENCES `lokalen` (`lokaalNummer`),
  ADD CONSTRAINT `tickets_blok_fk` FOREIGN KEY (`blokID`) REFERENCES `blokken` (`blokID`);
